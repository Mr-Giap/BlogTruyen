...
var QuickSidebar = function () {
    ...
    var handleQuickSidebarChat = function () {
        ...
        var handleChatMessagePost = function (e) {
            ...
            // handle post
            var time = new Date();
            var message = preparePost('out', (time.getHours() + ':' + time.getMinutes()), "Bob Nilson", 'logo', text);
            message = $(message);
            ...
            setTimeout(function(){
                var time = new Date();
                var message = preparePost('in', (time.getHours() + ':' + time.getMinutes()), "Ella Wong", 'logo', 'Lorem ipsum doloriam nibh...');
                message = $(message);
                chatContainer.append(message);
